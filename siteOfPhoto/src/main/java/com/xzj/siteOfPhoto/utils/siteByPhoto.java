...
public class siteByPhoto {
     ...
     * @throws Exception
     */
    public static void readImageInfo(File file) throws ImageProcessingException, Exception {
    ...
    private static void convertGpsToLoaction(double gps_latitude, double gps_longitude) throws IOException {
        ...
        res = HttpClientUtil.getRespInfoByGet(url).getContent();

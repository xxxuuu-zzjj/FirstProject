package com.tartan.insert.config;
...
public class SwaggerIIIConfig {
    @Value("${tartan.swagger.enabled}")
    private Boolean enableSwagger;

    @Value("${tartan.application.name}")
    private String applicationName;


    @Value("${tartan.application.version}")
    private String applicationVersion;


    @Value("${tartan.application.description}")

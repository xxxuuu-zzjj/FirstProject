package com.xzj.leetcode.leetcode.editor.cn;//给你一个整数数组 bloomDay，以及两个整数 m 和 k 。
//
...
class Solution {
    ...
    public boolean help(int[] bloomDay, int days, int m, int k){
        int flowers = 0;
        int bouquets = 0;
